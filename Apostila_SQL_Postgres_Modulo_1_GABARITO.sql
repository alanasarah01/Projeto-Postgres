...
select customer_id, full_name, is_active  from CUSTOMERS;
-- =========================================================
-- 4) WHERE (FILTRO)
-- =========================================================
...
select * from orders where payment_method != 'pix';
...
select full_name from customers where full_name ilike '%diego%';
